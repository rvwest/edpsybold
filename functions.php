...
if (!defined('EDPSY_FEATURES_CATEGORY_SLUG')) {
    define('EDPSY_FEATURES_CATEGORY_SLUG', 'features');
}

require_once get_template_directory() . '/inc/rest/class-rest-post-lookup.php';
require_once get_template_directory() . '/inc/customizer/homepage.php';
