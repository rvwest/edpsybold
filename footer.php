    ...
    <div class="footer-container grid12">
        ...
        <div class="footer-content">
					<p class="footer-social">
						...
						<a href="mailto:hello@edpsy.org.uk" class="footer-mail"><i class="fal fa-envelope"></i> hello@edpsy.org.uk</a>
					</p>
					...
					<p class="footer-message"><a href="/community-guidelines">Community guidelines</a> | <a
                            ...
                            <p class="foot-legal">edpsy ltd
Piccadilly Business Centre, Aldow Enterprise Park, Manchester, England, M12 6AE <br />
Company number: 12669513 (registered in England and Wales)</p>
