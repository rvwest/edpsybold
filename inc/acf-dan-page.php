...
acf_add_local_field_group( array(
    ...
    'fields'                => array(
        ...
        array(
            ...
            'type'          => 'textarea',
            'rows'          => 8,
            'instructions'  => 'Body copy displayed beside the illustration. Line breaks become paragraphs automatically.',
        ),
        array(
    ...
    'fields'                => array(
        ...
        array(
            ...
            'sub_fields'    => array(
                ...
                array(
                    'key'          => 'field_dan_collab_url',
                    'label'        => 'Organisation URL',
                    'name'         => 'collab_url',
                    'type'         => 'url',
                    'instructions' => 'Optional. Makes the whole card a clickable link.',
                    'required'     => 0,
                    'wrapper'      => array( 'width' => '25' ),
                ),
            ),
