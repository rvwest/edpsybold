...
?>
<div class="edp-events-calendar-list__event-date-tag">
	<time class="edp-events-calendar-list__event-date-tag-datetime" datetime="<?php echo esc_attr($event_date_attr); ?>"
		aria-hidden="true">
		<span class="edp-events-calendar-list__event-date-tag-weekday">
			<?php echo esc_html($event_week_day); ?>
		</span>
		<span class="edp-events-calendar-list__event-date-tag-daynum ">
			<?php echo esc_html($event_day_num); ?>
		</span>
		<span class="edp-events-calendar-list__event-date-tag-month">
