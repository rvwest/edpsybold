            ...
            <?php if ($cta_text || $cta_url): ?>
                <div class="dan-talks__cta">
                    ...
                    <?php if ($cta_url): ?>
                        ...
                        <a href="<?php echo esc_url($cta_url); ?>" type="submit" name="submit_job" value="1"
                            class="button edp-button-solid" tabindex="0">
                            book Dan to speak <i class="fas fa-arrow-right" aria-hidden="true"></i>
                        </a>
                    <?php endif; ?>
                </div>
            <?php endif; ?>
