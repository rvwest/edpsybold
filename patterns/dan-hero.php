...
?>
<section class="dan-hero edp-fullwidth" aria-label="Introduction">

    <?php if ($header_illus): ?>
        <img src="<?php echo esc_url($header_illus['url']); ?>" alt="" class="dan-hero__illustration"
            aria-hidden="true" />
    <?php else: ?>
        <img src="<?php echo esc_url(get_template_directory_uri() . '/images/edpsy-swirls-21.svg'); ?>" alt=""
            class="dan-hero__illustration" aria-hidden="true" />
    <?php endif; ?>
