...
<section class="dan-about" aria-label="About Dan">
    ...
    <?php if ( $illustration ) : ?>
        <img
            ...
            class="dan-about__illustration"
            aria-hidden="<?php echo empty( $illustration['alt'] ) ? 'true' : 'false'; ?>"
        />
    <?php else : ?>
        <img
            src="<?php echo esc_url( get_template_directory_uri() . '/images/edpsy-swirls-26.svg' ); ?>"
            alt=""
            class="dan-about__illustration"
            aria-hidden="true"
        />
    ...
    <div class="dan-about__content">
        ...
        <?php if ( $col1 || $col2 ) : ?>
            <div class="dan-about__body">
                ...
                <?php endif; ?>
                <?php if ( $col2 ) : ?>
                    <div class="dan-about__col"><?php echo wp_kses_post( $col2 ); ?></div>
                <?php endif; ?>
            </div>
        <?php endif; ?>
